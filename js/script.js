((global) => 
{
	...
	{
		key: 'portfolio-theme',
		darkVars: '--bg-primary:#0b1121;--bg-secondary:#0f172a;--bg-tertiary:rgba(15,23,42,0.72);--bg-glass:rgba(255,255,255,0.045);--bg-glass-hover:rgba(255,255,255,0.075);--bg-glass-active:rgba(255,255,255,0.11);--bg-elevated:rgba(15,23,42,0.68);--text-primary:#f8fafc;--text-secondary:#b6c2d2;--text-muted:#7c8aa0;--border-glass:rgba(255,255,255,0.09);--border-accent:rgba(147,197,253,0.28);--border-hover:rgba(147,197,253,0.48);--accent:#93c5fd;--accent-alt:#60a5fa;--accent-glow:rgba(147,197,253,0.28);--accent-gradient:linear-gradient(135deg,#60a5fa,#3b82f6);--accent-gradient-text:linear-gradient(135deg,#93c5fd,#2dd4bf);--shadow-sm:0 1px 4px rgba(0,0,0,0.28);--shadow-md:0 12px 28px rgba(0,0,0,0.28);--shadow-lg:0 24px 70px rgba(0,0,0,0.42);--shadow-glow:0 0 34px rgba(147,197,253,0.16)',
		lightVars: '--bg-primary:#f8fafc;--bg-secondary:#ffffff;--bg-tertiary:rgba(226,232,240,0.5);--bg-glass:rgba(255,255,255,0.7);--bg-glass-hover:rgba(255,255,255,0.85);--bg-glass-active:rgba(255,255,255,0.95);--bg-elevated:rgba(255,255,255,0.9);--text-primary:#0f172a;--text-secondary:#475569;--text-muted:#94a3b8;--border-glass:rgba(0,0,0,0.08);--border-accent:rgba(59,130,246,0.25);--border-hover:rgba(59,130,246,0.5);--accent:#3b82f6;--accent-alt:#60a5fa;--accent-glow:rgba(59,130,246,0.25);--accent-gradient:linear-gradient(135deg,#3b82f6,#60a5fa);--accent-gradient-text:linear-gradient(135deg,#1d4ed8,#3b82f6);--shadow-sm:0 1px 3px rgba(0,0,0,0.06);--shadow-md:0 4px 12px rgba(0,0,0,0.08);--shadow-lg:0 8px 32px rgba(0,0,0,0.1);--shadow-glow:0 0 30px rgba(59,130,246,0.15)',
		init() 
		{
